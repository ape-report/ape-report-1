...
```
// java.lang.RuntimeException: Unable to create application com.dramafever.large.DFApplication: android.database.sqlite.SQLiteCantOpenDatabaseException: unknown error (code 14): Could not open database
